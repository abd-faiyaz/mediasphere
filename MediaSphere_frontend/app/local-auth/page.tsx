...
export default function LocalAuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      >
        {/* Logo */}
        <motion.div variants={logoVariants} className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-full mb-4">
            <Users className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900">MediaSphere</h1>
          <p className="text-gray-600 mt-2">Local Authentication</p>
        </motion.div>
