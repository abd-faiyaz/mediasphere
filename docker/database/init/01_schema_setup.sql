-- MediaSphere Database Schema Initialization
-- This script creates the complete database schema for MediaSphere application
-- Database: db_408
...
-- Log schema creation
\echo 'MediaSphere database schema created successfully!'
